...
@endif
                ...
                <!-- TABLE-->
    <h1 class="text-center text-white">Wear Wise vendors</h1>
 ...
 @foreach($vendor_data as $vendor_data)
        <tr class='text-center'>
            ...
            <td><a onclick="return confirm('Confirm approve?')" class="btn btn-success" href="{{url('approve_vendor',$vendor_data->id)}}">Approve</a></td>
            <td><a onclick="return confirm('Confirm Delete?')" class="btn btn-danger" href="{{url('delete_vendor',$vendor_data->id)}}">Delete</a></td>
        </tr>
