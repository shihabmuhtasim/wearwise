...
@endif
 ...
 @foreach($product_data as $product_data)
        <tr class='text-center'>
            ...
            <td><a onclick="return confirm('Confirm approve?')" class="btn btn-success" href="{{url('approve_product',$product_data->id)}}">Approve</a></td>
            <td><a onclick="return confirm('Confirm Delete?')" class="btn btn-danger" href="{{url('a_v_delete_product',$product_data->id)}}">Delete</a></td>
        </tr>
